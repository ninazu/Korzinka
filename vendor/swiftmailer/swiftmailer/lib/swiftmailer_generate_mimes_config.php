...
<?php
define('APACHE_MIME_TYPES_URL', 'https://svn.apache.org/repos/asf/httpd/httpd/trunk/public_html/conf/mime.types');
...
function generateUpToDateMimeArray()
{
    ...
    $preamble .= " * autogenerated using https://svn.apache.org/repos/asf/httpd/httpd/trunk/public_html/conf/mime.types\n";
